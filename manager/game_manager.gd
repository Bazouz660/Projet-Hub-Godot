...
func change_gui_scene(new_scene_path: String, delete: bool = true, keep_running: bool = false) -> void:
	...
	if current_gui_scene != null:
		if delete:
			...
			root.gui.remove_child(current_gui_scene)
			scenes_in_memory[current_gui_scene.scene_file_path] = current_gui_scene
...
func change_3d_scene(new_scene_path: String) -> void:
	...
	var viewport = root.world.get_node("SubViewportContainer/SubViewport")
